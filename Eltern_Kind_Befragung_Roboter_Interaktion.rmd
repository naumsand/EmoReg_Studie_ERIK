...
Zun&auml;chst werden die Datensets "Kinder_full", "Eltern_full" und "Eltern_Uebung" geladen und &uuml;berpr&uuml;ft, wie viele Probanden gemessen wurden und wie die Verteilung auf die Gruppen (Avatar vs Roboter) aussieht.
...
**Wie aufgeregt bist du? & Wie f&uumlhlst du dich?** 
...
Hier werden semantische Differentiale auf einer Spanne von 1 bis 101 bewertet. Die Wertungen koennen auch zu drei Skalen zusammengefasst werden.
...
Mittels eines Venn-Diagramms in drei Stufen von N&auml;he haben die Kinder ihre gef&uuml;hlte N&auml;he zum Roboter bewertet. Die Grafiken zeigten entweder einen Jungen oder ein M&auml;dchen als Avatar des Kindes.


```{r pics_game1, out.width=c('50%','50%'), fig.show='hold', echo = FALSE, warning = FALSE}
...
**Hattest du generell das Gef&uuml;hl, dass das Spiel deine Aufregung steigert, also dich nerv&ouml;s macht, oder etwas stresst?**
...
```{r aufregung}
  ...
  round(mean(ds_kind$QF02_01,na.rm = TRUE),2)
```
...
```
```{r effekt_uebung_eltern_visualisierung}
...
**Hattest du das Gef&uuml;hl, dass Robbie dich beim Entspannen gut unterst&uuml;tzt hat?**
...
**Ich w&uuml;rde die Atem&uuml;bung gern wieder machen.**
