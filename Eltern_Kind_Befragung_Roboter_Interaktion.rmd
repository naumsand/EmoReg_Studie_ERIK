...
```{r effekt_uebung_eltern}
  ...
  # FG05 = Adherenz der Kinder durch Eltern eingeschaetzt
  diffscores <- ds_uebung[, .(EXC_NR,FG01_01, FG02_01,FG03_01,FG04_01,FG05, PID)]
...
## Visualisierung Adherenz pro Uebungsrunde
  # Daten fuer ggplot ins Long-format bringen
  adherence_long <- melt(diffscores,id.vars= c("EXC_NR", "PID"), measure.vars=c("FG05"))
